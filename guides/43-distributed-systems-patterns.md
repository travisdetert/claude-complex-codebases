...
```mermaid
flowchart LR
    Client -->|Commands| WS[Write Service]
    Client -->|Queries| RS[Read Service]
    WS --> WDB[(Write DB<br/>Normalized)]
    WDB -->|Events / CDC| RDB[(Read DB<br/>Denormalized)]
    RS --> RDB

    style WS fill:#e8f5e9,stroke:#2e7d32
    style RS fill:#e3f2fd,stroke:#1565c0
    style WDB fill:#e8f5e9,stroke:#2e7d32
    style RDB fill:#e3f2fd,stroke:#1565c0
```
