...
```mermaid
flowchart TD
    A[Identify Migration Need] --> B[Assess Scope & Risk]
...
flowchart TD
    subgraph "Direct Dependencies"
        A[UserController] --> TARGET
        B[AuthService] --> TARGET
        C[AdminPanel] --> TARGET
    end
    ...
    subgraph "Indirect Dependencies"
        ...
        E[Auth Integration Tests] --> B
        F[E2E Test Suite] --> A
        F --> C
    end

    subgraph "Infrastructure"
        G[Migration Scripts] --> TARGET
        H[Seed Data] --> TARGET
        I[CI Pipeline] --> G
    end

    style TARGET fill:#fff3e0,stroke:#e65100,stroke-width:3px
```
...
flowchart LR
    ...
    style BA4 fill:#e8f5e9,stroke:#2e7d32
    style BB2 fill:#ffcdd2,stroke:#c62828
```
...
flowchart TB
    ...
    subgraph "After: Extracted Service"
        direction TB
        S_AUTH[Auth Module]
        S_ORD[Order Module]
        S_DB[(Monolith DB)]
